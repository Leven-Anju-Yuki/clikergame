    ...
    const zones = {
        cuisine: {
            ...
            content: `
                ...
                ${currentLevel >= 2 ? `<button class="boutonavecimg" onclick="improveFeedRabbit()">Améliorer</button>` : ''}
            `,
        },
        chambre: {
            ...
            content: `
                ...
                ${currentLevel >= 3 ? `<button class="boutonavecimg" onclick="improvePutRabbitToSleep()">Améliorer</button>` : ''}
            `,
        },
        sdb: {
            ...
            content: `
                ...
                ${currentLevel >= 4 ? `<button class="boutonavecimg" onclick="improveCleanRabbit()">Améliorer</button>` : ''}
            `,
        },
        jardin: {
            ...
            content: `
                ...
                ${currentLevel >= 5 ? `<button class="boutonavecimg" onclick="improvePlayWithRabbit()">Améliorer</button>` : ''}
            `,
        },
    };
